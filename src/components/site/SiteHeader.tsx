      ...
      <div className="container-x flex h-20 items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <span className="flex flex-col leading-tight">
            <span className="text-base sm:text-lg md:text-xl font-bold tracking-wide text-foreground">
              BRAVENTI
            </span>
            <span className="text-[9px] sm:text-[10px] md:text-xs font-semibold tracking-[0.28em] text-primary">
              HOLDINGS
            </span>
          </span>
        </Link>
